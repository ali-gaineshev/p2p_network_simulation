...
main(int argc, char* argv[])
{
    ...
    // Ptr<P2PApplication> appToDisable = DynamicCast<P2PApplication>(net.nodes.Get(3)->GetApplication(0));
    // Simulator::Schedule(Seconds(2.0), &P2PApplication::SetDisableNode, appToDisable, true);

    // Ptr<P2PApplication> appToDisable2 = DynamicCast<P2PApplication>(net.nodes.Get(2)->GetApplication(0));
    // Simulator::Schedule(Seconds(2.0), &P2PApplication::SetDisableNode, appToDisable2, true);
